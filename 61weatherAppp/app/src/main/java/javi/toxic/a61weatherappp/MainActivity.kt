...
import javi.toxic.a61weatherappp.R
import javi.toxic.a61weatherappp.ForecastAct
...
class MainActivity : AppCompatActivity() {
    ...
    fun showWeatherForecast(view: View){
        val intent = Intent(this, ForecastAct::class.java)
